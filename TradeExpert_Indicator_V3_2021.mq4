...
extern const string Properties="----------------------------------License Property------------------------------";
extern string License="_________________________Enter your  license key here!__________________";



input string Username=" Enter your username";

input string Password=" Enter your password";
...
string	IndName = "TrendExpert2021";
...
datetime allowed_until = D'2021.10.07 00:00';    
...
if(initDate<endDate && License==generatedLicense[0]){
  ...
  answer="Limited";
}else if(License==generatedLicense[3] ){
answer="Unlimited";
}else if(endDate==initDate &&( License==generatedLicense[1] ||License==generatedLicense[0])){
answer= "Expired";
}else{answer="Invalid";
}
...
bool  ExpertStatus(){ 
 if(licenseState()=="Actif" ||(licenseState()=="Trial Mode" && endDate>initDate)){return true;}
